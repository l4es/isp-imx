...
CacCanvasPicker::CacCanvasPicker( QwtPlot *plot )
...
bool CacCanvasPicker::event( QEvent *e )
{
...
bool CacCanvasPicker::eventFilter( QObject *object, QEvent *e )
{
...
void CacCanvasPicker::select( const QPoint &pos )
{
...
void CacCanvasPicker::moveBy(int dx, int dy)
{
    if ( dx == 0 && dy == 0 )
        return;
...
// Move the selected point
void CacCanvasPicker::move(const QPoint &pos)
{
    if ( !d_selectedCurve )
        return;
...
void CacCanvasPicker::showCursor(bool showIt)
{
    if ( !d_selectedCurve )
        return;
...
void CacCanvasPicker::shiftCurveCursor(bool up)
{
...
void CacCanvasPicker::shiftPointCursor(bool up)
{
    if ( !d_selectedCurve )
        return;
