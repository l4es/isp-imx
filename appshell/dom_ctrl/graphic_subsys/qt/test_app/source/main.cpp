...
RESULT fillRGBW( PicBufMetaData_t *pPicBufMetaData )
{
    ...
    uchar *pBuf   = pPicBufMetaData->Data.RGB.combined.pBuffer;
...
int testVidplayer( domCtrlVidplayHandle_t hVidPlayer = 0, QWidget *parent = 0 )
{
    ...
    PicBufMetaData.Data.RGB.combined.pBuffer        = (uint8_t*)malloc( PicBufMetaData.Data.RGB.combined.PicHeightPixel * PicBufMetaData.Data.RGB.combined.PicWidthBytes );
    if (PicBufMetaData.Data.RGB.combined.pBuffer == NULL)
    {
    ...
    // free image buffer
    free( PicBufMetaData.Data.RGB.combined.pBuffer );
