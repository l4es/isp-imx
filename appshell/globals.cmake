...
if (ANDROID)
set (CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wall -fPIC -Wno-parentheses-equality -Wno-newline-eof -Wno-sometimes-uninitialized -Wno-enum-conversion -Wno-deprecated-declarations -Wno-unused-private-field")
else ()
...
set (CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -O2 -DDEBUG -g2 -ggdb")
set (CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -fno-strict-aliasing -O3")
