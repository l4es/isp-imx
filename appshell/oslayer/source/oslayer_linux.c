 ...
 *  thread. The function call returns immediately, if event is already signaled.
 *
 *  @param  pEvent                    Reference of the event object
 *
 *  @return                           Status of operation
 ...
 *  Wait for the state of the event object becoming true and block calling
 *  thread. The function call returns immediately, if event is already signaled.
 *  If specified timeout elapses, the function returns with appropriate timeout
 *  error code.
 *
 *  @param  pEvent      reference of the event object
 *
 ...
 *
 *  @return            Current clock tick. The resolution of clock tick can
 ...
 *
 *  @return            The resolution of the clock tick.
 *
 ******************************************************************************/
