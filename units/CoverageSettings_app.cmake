...
if ( ENABLE_CODECOVERAGE )
    ...
    if ( CMAKE_COMPILER_IS_GNUCXX OR CMAKE_COMPILER_IS_GNUCXX )
       ...
       set( CMAKE_EXE_LINKER_FLAGS ${CMAKE_EXE_LINKER_FLAGS} --coverage )
        ...
        add_custom_target( ${application}_coverage_init ${CODECOV_LCOV} --base-directory .
        ...
        add_dependencies(coverage_init ${application}_coverage_init)

        add_custom_target( ${application}_coverage ${CODECOV_LCOV} --base-directory .
                --directory ${CMAKE_BINARY_DIR} --output-file ${CODECOV_OUTPUTFILE} --capture
        ...
        add_dependencies(coverage ${application}_coverage)
