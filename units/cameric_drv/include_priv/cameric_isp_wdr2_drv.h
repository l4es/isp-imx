...
#ifndef __CAMERIC_ISP_WDR2_DRV_H__
#define __CAMERIC_ISP_WDR2_DRV_H__

/**
 * @file cameric_isp_wdr2_drv.h
 *
 * @brief
 *
 *****************************************************************************/
 ...
 *
 */
typedef struct CamerIcIspWdr2Context_s
{
    bool_t      enabled;
    bool_t      cfg_update;
} CamerIcIspWdr2Context_t;
