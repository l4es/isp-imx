...
#ifdef FPGA_SUPPORT_PACKAGE
void HalPhyRst(HalHandle_t HalHandle);
void HalPhyCtrl(HalHandle_t HalHandle);
#endif
/*****************************************************************************/
/**
 *          HalFpgaDereset()
...
#ifndef FPGA_SUPPORT_PACKAGE
void HalMipiCsiinit(HalHandle_t HalHandle);
void HalFpgaPreSet(HalHandle_t HalHandle);
#endif
#ifdef FPGA_SUPPORT_PACKAGE
void HalFpgaPreSet(HalHandle_t HalHandle);
void HalFpgaTpgCtrl(HalHandle_t HalHandle);
void HalFpgaStreamControl_bus0(HalHandle_t HalHandle, unsigned int stream_ctrl);
void HalFpgaStreamControl_bus1(HalHandle_t HalHandle, unsigned int stream_ctrl);

int HalFpgaInitialRegisterFile(HalHandle_t hHal,        const char *iniRegFileName);
int HalFpgaRegisterInitial(HalHandle_t hHal, const char *registerFileName, int inibool);
#endif
