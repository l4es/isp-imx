 ...
 *****************************************************************************/
#define OV2775_PIDH                         (0x300A)  //R  - Product ID High Byte MSBs
#define OV2775_PIDL                         (0x300B)  //R  - Product ID Low Byte LSBs
 ...
 * SC control registers
 *****************************************************************************/
#define OV2775_PIDH_DEFAULT                        (0x27) //read only
#define OV2775_PIDL_DEFAULT                        (0x70) //read only
...
static RESULT OV2775_IsiCreateSensorIss(IsiSensorInstanceConfig_t *
                          pConfig);
...
static RESULT OV2775_IsiSensorSetPowerIss(IsiSensorHandle_t handle,
                            bool_t on);

static RESULT OV2775_IsiGetSensorRevisionIss(IsiSensorHandle_t handle,
                               uint32_t * p_value);

static RESULT OV2775_IsiSetBayerPattern(IsiSensorHandle_t handle,
                          uint8_t pattern);

static RESULT OV2775_IsiGetGainLimitsIss(IsiSensorHandle_t handle,
                             float *pMinGain,
                             float *pMaxGain);

static RESULT OV2775_IsiGetIntegrationTimeLimitsIss(IsiSensorHandle_t
                                 handle,
                                 float
                                 *pMinIntegrationTime,
                                 float
...
static RESULT OV2775_IsiExposureControlIss(IsiSensorHandle_t handle,
                            float NewGain,
...
static RESULT OV2775_IsiGetGainIss(IsiSensorHandle_t handle,
                        float *pSetGain);

static RESULT OV2775_IsiGetVSGainIss(IsiSensorHandle_t handle,
                          float *pSetGain);

static RESULT OV2775_IsiGetGainIncrementIss(IsiSensorHandle_t handle,
                             float *pIncr);

static RESULT OV2775_IsiSetGainIss(IsiSensorHandle_t handle,
                        float NewGain, float *pSetGain,
                        float *hdr_ratio);

static RESULT OV2775_IsiSetVSGainIss(IsiSensorHandle_t handle,
                          float NewIntegrationTime,
                          float NewGain, float *pSetGain,
                          float *hdr_ratio);
...
static RESULT OV2775_IsiGetVSIntegrationTimeIss(IsiSensorHandle_t
                             handle,
                             float
                             *pSetIntegrationTime);

static RESULT OV2775_IsiGetIntegrationTimeIncrementIss(IsiSensorHandle_t handle,
                             float *pIncr);
...
static RESULT OV2775_IsiSetVSIntegrationTimeIss(IsiSensorHandle_t
                             handle,
                             float
                             NewIntegrationTime,
                             float
