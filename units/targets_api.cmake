...
get_target_property(CREATE_ALLDIR create_alldir TYPE)
if(NOT CREATE_ALLDIR)
    add_custom_target(create_alldir)
endif()
# the library itself is a dependency for the target lib
add_dependencies(create_alldir ${module}_create_dir)
...
get_target_property(CREATE_DIR create_dir TYPE)
if(NOT CREATE_DIR)
    add_custom_target(create_dir)
endif()
add_dependencies(create_dir ${module}_copy_header)
